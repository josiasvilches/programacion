...
def create_app():
    ...
    api.add_resource(resources.ProductoValoracionesResource, '/productos/<int:id>/valoraciones')
    ...
    api.add_resource(resources.ValoracionesRecientesResource, '/valoraciones/recientes')
    api.add_resource(resources.VerificarCompraProductoResource, '/valoraciones/verificar-compra/<int:id_producto>/<int:id_usuario>')
